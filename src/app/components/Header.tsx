...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-30 bg-white/95 backdrop-blur after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-[3px] after:bg-[image:var(--brand-gradient-x)] after:content-['']">
